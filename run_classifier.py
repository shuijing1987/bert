...
parser = argparse.ArgumentParser(description='Using argparse for string type arguments')
...
parser.add_argument(
    "--bert_config_file", type=str, default=None, required=True, 
    help="The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

parser.add_argument("--task_name", type=str, default=None, required=True, help="The name of the task to train.")
...
parser.add_argument("--predict_batch_size", type=int, default=8, help="Total batch size for predict.")
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      train_op = tf.keras.optimizer.Adam(
